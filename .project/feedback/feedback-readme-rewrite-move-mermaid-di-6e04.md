...
## UX
- [x] F001 README.md needs a complete rewrite — current content is stale/thin
  relative to what a published npm package's README should cover (install,
  usage, config, links to deeper docs).
- [x] F002 The Mermaid diagrams currently living in README.md (Datamodel,
...
## Reconsidered
- [x] F003 `/ardd-render`'s render config (`.claude/skills/ardd-render/SKILL.md`)
